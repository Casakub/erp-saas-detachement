...
- RBAC LOCKED V1: `ERP Détachement europe/SOCLE TECHNIQUE GELÉ — V1 (LOCKED)/2.12.a — RBAC & PERMISSIONS (MATRIX) — V1 30a688d6a596805ea41ae2abb55cbb97.md`
- OpenAPI V1.2 patch DRAFT: `ERP Détachement europe/SOCLE TECHNIQUE GELÉ — V1.2 (DRAFT)/2.11.a — OPENAPI V1.2 (PATCH) — SURFACES MANQUANTES 30d688d6a59680e2b6a9d15b762899c1.md`
