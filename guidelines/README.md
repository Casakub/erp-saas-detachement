...
- `Guidelines.md`: regles operationnelles Figma Make.
- `FIGMA_MAKE_QUICKSTART.md`: prompts courts prets a coller pour lancer une session rapidement.
