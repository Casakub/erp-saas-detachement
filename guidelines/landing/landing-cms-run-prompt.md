# Landing - CMS Run Prompt (Copy/Paste)
...
4. `guidelines/landing/landing-cms-architecture.md`
...
- Scope: pages publiques + surfaces CMS interne + SEO/i18n UI.
- Interdit: logique metier backend decisionnelle.
- Interdit: rupture de style visuel global.
